...
const names = [
  ...
  // special foils (one surge, one fracture): hidden from the view and stats by default
  ['310','Erebor Reclaimed','mythic','Sorcery',''],
  ['311','The Arkenstone','mythic','Legendary Artifact',''],
];
const specialFoil = { '310': ['surgefoil'], '311': ['fracturefoil'] };
